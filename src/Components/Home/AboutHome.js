...
const AboutHome = () => {
    ...
    <div id="services" className="bg-white py-12">
      <section data-aos="zoom-in-down">
        <div className="my-4 py-4">
          ...
          {/* <h2 className="my-2 text-center text-3xl text-blue-400 uppercase font-bold">
            services
          </h2>
          ...
          <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-blue-400">
            ...
            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
              <div className="m-2 text-justify text-sm">
                <img
                  ...
                  src={img}
                />
                <h2 className="font-semibold my-4 text-2xl text-center text-blue-400">
                  Web Development
                </h2>
  ...
  <button className="py-2 px-4 text-white text-xl bg-blue-400 rounded-full">
    Read More
  </button>
</div>
